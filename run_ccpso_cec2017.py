...
from CCPSO_CEC2017 import CCPSO_CEC2017

print("Dimensions size?")
D = int(input())
algos = ['CCPSO', 'PSO']
df_cols = ['Fn', 'CCPSO', 'PSO']
...
for fi in range(1, 31):
    ...
    test1 = CCPSO_CEC2017(fnum=fi, dimensions=D, default_bounds=(-100, 100), max_FES=3e+05, num_runs=31,
                          popsize=100, w=0.4, c1=1, c2=1, NC=10)
    ...
    test2 = CCPSO_CEC2017(fnum=fi, dimensions=D, default_bounds=(-100, 100), max_FES=3e+05, num_runs=31,
                          popsize=100, w=0.4, c1=1, c2=1, NC=0)
